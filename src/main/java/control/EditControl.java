...
public class EditControl extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String pcapacity = request.getParameter("capacity");
		...
		DAO dao = new DAO();
		dao.editProduct(pname, pimage, pprice, ptitle, pdescription, pcategory, pmodel, pcapacity, pdelivery, pimage2,
				pimage3, pimage4, pid);
        request.setAttribute("mess", "Đã Cập Nhật!");
