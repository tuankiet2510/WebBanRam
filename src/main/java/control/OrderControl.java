...
public class OrderControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			email.setFrom("websitebanr@gmail.com"); // chinh lai email quan tri tai day [chu y dung email con hoat dong]
			email.setFromPassword("quuzazonmnzntald"); // mat khau email tren
            /*
            email.setFrom("tuan81358@gmail.com"); // chinh lai email quan tri tai day [chu y dung email con hoat dong]
			email.setFromPassword("25102002");*/
