				  	...
				  	${mess}
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" class="border-0 bg-light">
                                                     ...
                                                     <th scope="col" class="border-0 bg-light">
                                                        <div class="py-2 text-uppercase">Dung lượng</div>
                                                    </th>
                                                     <th scope="col" class="border-0 bg-light">
                                                        <div class="py-2 text-uppercase">Vận chuyển</div>
                                                    </th>
                                                     <th scope="col" class="border-0 bg-light">
                                                        <div class="py-2 text-uppercase">Xuất xứ</div>
                                                    </th>
                                                    <th scope="col" class="border-0 bg-light">
                                            ...
                                            <c:forEach items="${listCart}" var="o">
                                             <c:forEach items="${listProduct}" var="p">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><strong>${p.capacity}</strong></td>
                                                    <td class="align-middle"><strong>${p.delivery}</strong></td>
                                                    
                     <td class="align-middle">
                     	<strong>${o.made_in}</strong>
                    </td>
                                    ...
                                    <ul class="list-unstyled mb-4" id="contentTotalMoney">
                                       <!--  <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>100 $</strong></li>
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                            <h5 class="font-weight-bold">90 $</h5>
                                        </li> -->
