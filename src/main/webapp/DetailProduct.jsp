				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="table-responsive">
							<table class="table table-sm table-borderless mb-0">
								<tbody>
									...
									<tr>
										<th class="pl-0 w-25" scope="row"><strong>Capacity</strong></th>
						...
						<form action="addCart?pid=${detail.id }" method="post">
											...
											<td>
												<div class="mt-1">
													<div class="form-check form-check-inline pl-0">
														<input type="radio" class="form-check-input" id="American"
															value="American" name="made_in" checked> <label
															class="form-check-label small text-uppercase card-link-secondary"
															for="American">American</label>
													</div>
													<div class="form-check form-check-inline pl-0">
														<input type="radio" class="form-check-input"
															id="Singapore" value="Singapore" name="made_in">
														<label
															class="form-check-label small text-uppercase card-link-secondary"
															for="Singapore">Singapore</label>
													</div>
													<div class="form-check form-check-inline pl-0">
														<input type="radio" class="form-check-input" id="Japan"
															value="Japan" name="made_in"> <label
															class="form-check-label small text-uppercase card-link-secondary"
															for="Japan">Japan</label>
													</div>
												</div>
											</td>
										</tr>
							...
							<div class="mt-1">
								<!-- <button type="submit" class="btn btn-primary btn-md mr-1 mb-2">Mua
									ngay</button> -->
						...
						<%-- <form action="sellCart?pid=${detail.id }" method="post">
							<div class="mt-1">
								<button type="submit" class="btn btn-primary btn-md mr-1 mb-2">Mua
									ngay</button>
							</div>
			...
			<div class="classic-tabs">
				...
				<div class="tab-content" id="advancedTabContent">
					...
					<div class="tab-pane fade" id="reviews" role="tabpanel"
						...
						<h5>
							<span>${countAllReview }</span> đánh giá cho <span>${detail.name }</span>
						</h5>
						...
						<div>
							...
							<div class="text-right pb-2">
								<button type="button" class="btn btn-primary"
									onclick="addReview(${detail.id})">Thêm đánh giá</button>
							</div>
						</div>
